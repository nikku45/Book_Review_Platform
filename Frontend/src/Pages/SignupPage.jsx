...
import { User, Mail, Lock, BookOpen, AlertCircle, CheckCircle, Loader2, Eye, EyeOff } from 'lucide-react';
...
const SignupPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const action = await dispatch(signupUser({
                name: formData.name,
            ...
            if (action.meta.requestStatus === 'fulfilled') {
                ...
                setLocalError(action.payload?.message || 'Signup failed. Please try again.');
            }
        } catch (err) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Join BookReview</h1>
                    <p className="text-gray-600">Create your account to start reviewing books</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                    ...
                    {/* Error Message */}
                    {(localError || (status === 'failed' && error)) && (
                    ...
                    <div className="space-y-6">
                        ...
                        <button
                            ...
                            disabled={isSubmitting || loading || status === 'fulfilled'}
